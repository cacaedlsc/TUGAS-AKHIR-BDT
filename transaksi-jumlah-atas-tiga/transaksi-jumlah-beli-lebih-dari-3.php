...
<div class="content">
    ...
    if(isset($_GET['search']) && !empty($_GET['search'])) {
        ...
        $sql = "SELECT * FROM info_jumlah_atas_tiga WHERE kode_plg LIKE '%$searchKeyword%' OR kode_brg LIKE '%$searchKeyword%' OR jumlah_beli LIKE '%$searchKeyword%'";
    } else {
        $sql = "SELECT * FROM info_jumlah_atas_tiga";
    }
