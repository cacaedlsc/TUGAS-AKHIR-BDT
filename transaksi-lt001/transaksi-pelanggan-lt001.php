...
<div class="content">
    ...
    if(isset($_GET['search']) && !empty($_GET['search'])) {
        ...
        $sql = "SELECT * FROM transaksi_pelanggan_lt001 WHERE kode_plg LIKE '%$searchKeyword%' OR kode_brg LIKE '%$searchKeyword%' OR jumlah_beli LIKE '%$searchKeyword%'";
    } else {
        $sql = "SELECT * FROM transaksi_pelanggan_lt001";
    }
