...
<div class="content">
    <h1 class="dashboard">Data Pelanggan</h1>
    <?php 
    include './../koneksi.php';
    $searchKeyword = "";
    if(isset($_GET['search']) && !empty($_GET['search'])) {
        $searchKeyword = $_GET['search'];
        $sql = "SELECT * FROM pelanggan WHERE kode_plg LIKE '%$searchKeyword%' OR nama_plg LIKE '%$searchKeyword%'";
    } else {
    ...
    <thead>
        ...
        <?php while ($row = mysqli_fetch_assoc($result)) { ?>
            <tr>
                ...
                <td>
                    <a href="pelanggan-edit-akun.php?id=<?php echo $row['id_pelanggan']; ?>" class="btn">Edit</a>
                    <a href="pelanggan-delete.php?id=<?php echo $row['id_pelanggan']; ?>" class="btn" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');">Hapus</a>
