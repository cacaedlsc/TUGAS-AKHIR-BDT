...
<form method="POST" action="transaksi-aksi-edit.php" class="customform">
        ...
        <input name="jumlah_beli" class="required" placeholder="Masukkan Jumlah Beli (Angka)" title="Jumlah Beli" type="text" value="<?php echo $data['jumlah_beli']; ?>" required/>
